...
public class Aircraft {
    ...
    public Aircraft(double angle) {
        colour = "resources//aircraft.png"; // set the colour as the default (purple)
    ...
    public void grow(boolean size) {
        if (size == true) {
            sizeX = (int) Math.pow(1.5, 0.15 * (age)-1); // grows the horizontal size
            sizeY = (int) Math.pow(1.5, 0.15 * (age)-1); // grows the vertical size
        }
